...
var client = new client_translate_1.TranslateClient({ region: 'eu-north-1' });
var params = {
    SourceLanguageCode: 'sv',
    TargetLanguageCode: 'te',
    Text: 'Hey, My name is krishna and how can i help you ?'
};
var command = new client_translate_1.TranslateTextCommand(params);
var translate = function () { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, client.send(command)];
            case 1:
                data = _a.sent();
                console.log(data);
                return [2 /*return*/];
